...
namespace SplatDev.Umbraco.Plugins.Surveys.Migrations;
...
/// </remarks>
public class CreateSurveysTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreateSurveysTables(IMigrationContext context, IServiceProvider serviceProvider)
