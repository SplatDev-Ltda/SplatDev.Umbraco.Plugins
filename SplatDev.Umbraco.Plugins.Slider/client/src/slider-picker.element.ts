...
/**
 * Choose which slider a page shows.
 *
 * The plugin stores sliders in its own tables and had no way at all for a page to reference
 * one — no view component, no picker. A slider could be built and never shown.
 *
 * The value stored is the numeric id, which is what the view component takes.
 */
@customElement("slider-picker")
export class SliderPickerElement extends UmbElementMixin(LitElement) {
...
export default SliderPickerElement;

declare global {
  interface HTMLElementTagNameMap {
    "slider-picker": SliderPickerElement;
  }
}
