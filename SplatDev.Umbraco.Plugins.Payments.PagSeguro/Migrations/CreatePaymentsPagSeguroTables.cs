...
namespace SplatDev.Umbraco.Plugins.Payments.PagSeguro.Migrations;
...
/// </remarks>
public class CreatePaymentsPagSeguroTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreatePaymentsPagSeguroTables(IMigrationContext context, IServiceProvider serviceProvider)
        : base(context) => _serviceProvider = serviceProvider;

    protected override void Migrate()
    {
        using var scope = _serviceProvider.CreateScope();
        var dbContext = scope.ServiceProvider.GetRequiredService<PagSeguroDbContext>();
