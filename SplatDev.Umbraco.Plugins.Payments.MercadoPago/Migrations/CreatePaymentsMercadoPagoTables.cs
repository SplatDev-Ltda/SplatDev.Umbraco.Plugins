...
namespace SplatDev.Umbraco.Plugins.Payments.MercadoPago.Migrations;
...
/// </remarks>
public class CreatePaymentsMercadoPagoTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreatePaymentsMercadoPagoTables(IMigrationContext context, IServiceProvider serviceProvider)
        : base(context) => _serviceProvider = serviceProvider;

    protected override void Migrate()
    {
        using var scope = _serviceProvider.CreateScope();
        var dbContext = scope.ServiceProvider.GetRequiredService<MercadoPagoDbContext>();
