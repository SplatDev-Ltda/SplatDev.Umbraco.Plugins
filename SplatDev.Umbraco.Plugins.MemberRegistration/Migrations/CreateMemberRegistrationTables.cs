...
namespace SplatDev.Umbraco.Plugins.MemberRegistration.Migrations;
...
/// </remarks>
public class CreateMemberRegistrationTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreateMemberRegistrationTables(IMigrationContext context, IServiceProvider serviceProvider)
        : base(context) => _serviceProvider = serviceProvider;

    protected override void Migrate()
    {
        using var scope = _serviceProvider.CreateScope();
        var dbContext = scope.ServiceProvider.GetRequiredService<MemberRegistrationDbContext>();
