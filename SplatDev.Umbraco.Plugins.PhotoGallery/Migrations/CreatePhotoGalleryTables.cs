...
namespace SplatDev.Umbraco.Plugins.PhotoGallery.Migrations;
...
/// </remarks>
public class CreatePhotoGalleryTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreatePhotoGalleryTables(IMigrationContext context, IServiceProvider serviceProvider)
