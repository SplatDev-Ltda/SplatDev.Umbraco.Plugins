...
namespace SplatDev.Umbraco.Plugins.Settings.Migrations;
...
/// </remarks>
public class CreateSettingsTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreateSettingsTables(IMigrationContext context, IServiceProvider serviceProvider)
