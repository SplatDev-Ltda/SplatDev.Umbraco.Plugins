...
let p = class extends U {
  ...
  render() {
    ...
    return u`<section class="preview" aria-label="Ad Preview"><a href=${i(this, a).url || "#"} target="_blank" rel="noopener" title=${i(this, a).tooltip} @click=${(t) => !i(this, a).url && t.preventDefault()}><div class="image ${e}">${i(this, a).img ? u`<img src=${i(this, a).img} alt=${i(this, a).title} />` : u`<span>Select media or enter an image URL</span>`}${i(this, a).overlay ? u`<div class="overlay"><strong>${i(this, a).title}</strong><span>${i(this, a).description}</span></div>` : ""}</div></a><footer><uui-button look="secondary" ?disabled=${this.readonly} @click=${l(this, s, w)}>Edit ad</uui-button><uui-button look="secondary" ?disabled=${this.readonly} @click=${l(this, s, C)}>Remove</uui-button></footer></section>`;
  }
};
