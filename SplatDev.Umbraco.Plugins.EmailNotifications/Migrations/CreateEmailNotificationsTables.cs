...
namespace SplatDev.Umbraco.Plugins.EmailNotifications.Migrations;
...
/// </remarks>
public class CreateEmailNotificationsTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreateEmailNotificationsTables(IMigrationContext context, IServiceProvider serviceProvider)
        : base(context) => _serviceProvider = serviceProvider;

    protected override void Migrate()
    {
        using var scope = _serviceProvider.CreateScope();
        var dbContext = scope.ServiceProvider.GetRequiredService<EmailNotificationsDbContext>();
