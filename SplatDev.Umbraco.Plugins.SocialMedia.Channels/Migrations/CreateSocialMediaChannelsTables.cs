...
namespace SplatDev.Umbraco.Plugins.SocialMedia.Channels.Migrations;
...
/// </remarks>
public class CreateSocialMediaChannelsTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreateSocialMediaChannelsTables(IMigrationContext context, IServiceProvider serviceProvider)
        : base(context) => _serviceProvider = serviceProvider;

    protected override void Migrate()
    {
        using var scope = _serviceProvider.CreateScope();
        var dbContext = scope.ServiceProvider.GetRequiredService<SocialChannelsDbContext>();
