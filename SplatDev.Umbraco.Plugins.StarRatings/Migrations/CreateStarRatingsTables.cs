...
namespace SplatDev.Umbraco.Plugins.StarRatings.Migrations;
...
/// </remarks>
public class CreateStarRatingsTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreateStarRatingsTables(IMigrationContext context, IServiceProvider serviceProvider)
        : base(context) => _serviceProvider = serviceProvider;

    protected override void Migrate()
    {
        using var scope = _serviceProvider.CreateScope();
        var dbContext = scope.ServiceProvider.GetRequiredService<StarRatingsDbContext>();
