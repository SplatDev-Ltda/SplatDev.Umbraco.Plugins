...
namespace SplatDev.Umbraco.Plugins.Payments.BancoInter.Migrations;
...
/// </remarks>
public class CreatePaymentsBancoInterTables : MigrationBase
{
    private readonly IServiceProvider _serviceProvider;

    public CreatePaymentsBancoInterTables(IMigrationContext context, IServiceProvider serviceProvider)
        : base(context) => _serviceProvider = serviceProvider;

    protected override void Migrate()
    {
        using var scope = _serviceProvider.CreateScope();
        var dbContext = scope.ServiceProvider.GetRequiredService<BancoInterDbContext>();
